...
console.log(properties)
    ...
    const handlePay = (propertyId, amount) => {
    ...
    return (
        <div className="container  mx-auto p-4">
            <h1 className="text-2xl font-bold mb-4">Properties You've Offered For</h1>
            {properties.length === 0 ? (
                    ...
                    {properties.map((property) => (
                        ...
                        >
                            ...
                            {property.status === 'accepted' && (
                                ...
                                onClick={() => handlePay(property._id, property.offerAmount)}
                                >
                                    Pay
                                </button>
                            )}
